        ...
        <div class="col-12 mb-4 mt-2">
          ...
          @foreach ($distinct as $subcategory)
            ...
            <a href="{{ route('subProducts', ['category' => $category, 'subcategory' => $subcategory->product_subcategory]) }}">
              @if($subcategory->product_subcategory === $subcategoryVal)
              <button class="btn rounded-pill mt-4 mx-2 px-3 py-1 font-med" style="border: 1px solid #804916; color: #804916; width: 180px; font-size: 20px; background: #EFE4CF;">{{ $subcategory->product_subcategory }}</button>
              @else
