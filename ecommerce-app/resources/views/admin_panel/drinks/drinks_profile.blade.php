              ...
              <div class="content">
                <div class="d-flex align-items-center justify-content-between">
                  ...
                  <div class="col-12 bgc-white mt-3 mx-auto p-5 rounded-3" style="min-height: 20vh;">
                    ...
                    <form method="POST" action="{{ route('addDrinks') }}" enctype="multipart/form-data" class="row rounded-3 col-12 bgc-primary mx-auto" enctype="" style="min-height: 20vh;">
                      @csrf
                      ...
                      <div class="col-lg-7 col-12 mb-5 mb-lg-0 position-relative mx-auto d-flex align-items-center">
                        ...
                        <div class="mx-auto w-75 ">
                          ...
                          <div class="d-flex align-items-center">
                            ...
                            <input type="text" hidden name="product_category" value="Drinks">
                            ...
                            <select required name="product_subcategory" id="" class="py-2 px-2 rounded-3 bgc-light font-reg w-100" style="font-size: 18px; width: 50%; outline: none;">
                              <option class="py-2 px-2 mx-1 rounded-3 bgc-light font-reg" style="font-size: 18px; width: 50%; outline: none;" value="Milkshake">Milkshake</option>
                              <option class="py-2 px-2 mx-1 rounded-3 bgc-light font-reg" style="font-size: 18px; width: 50%; outline: none;" value="Fresh Juice">Fresh Juice</option>
                              <option class="py-2 px-2 mx-1 rounded-3 bgc-light font-reg" style="font-size: 18px; width: 50%; outline: none;" value="Smoothies">Smoothies</option>
                              <option class="py-2 px-2 mx-1 rounded-3 bgc-light font-reg" style="font-size: 18px; width: 50%; outline: none;" value="Mocktail">Mocktail</option>
                            </select>
                          </div>
