              ...
              <div class="content">
                <div class="d-flex align-items-center justify-content-between">
                  ...
                  <div class="col-12 bgc-white mt-3 mx-auto p-5 rounded-3" style="min-height: 20vh;">
                    ...
                    <form method="POST" action="{{ route('updatePizza', ['id' => $product->id]) }}" enctype="multipart/form-data" class="row rounded-3 col-12 bgc-primary mx-auto" style="min-height: 20vh;">
                      @csrf
                      @method('PUT')
                      ...
                      <div class="col-lg-7 col-12 mb-5 mb-lg-0 position-relative mx-auto d-flex align-items-center">
                        ...
                        <div class="mx-auto w-75" >
                          ...
                          <label for="" class="txt-light font-med mt-2 mb-1" style="font-size: 25px;">Categories</label>
                          <div class="d-flex align-items-center">
                            <input type="text" hidden value="{{$product->product_category}}" name="product_category">
                            <input type="text" hidden value="{{$product->product_subcategory}}" name="product_subcategory">
