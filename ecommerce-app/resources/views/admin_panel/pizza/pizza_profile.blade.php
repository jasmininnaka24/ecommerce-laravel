              ...
              <div class="content">
                <div class="d-flex align-items-center justify-content-between">
                  ...
                  <div class="col-12 bgc-white mt-3 mx-auto p-5 rounded-3" style="min-height: 20vh;">
                    ...
                    <form method="POST" action="{{ route('addPizza') }}" enctype="multipart/form-data" class="row rounded-3 col-12 bgc-primary mx-auto" enctype="" style="min-height: 20vh;">
                      @csrf
                      ...
                      <div class="col-lg-7 col-12 mb-5 mb-lg-0 position-relative mx-auto d-flex align-items-center">
                        ...
                        <div class="mx-auto w-75 ">
                          ...
                          <div class="d-flex align-items-center">
                            ...
                            <input type="text" hidden name="product_category" value="Pizza">
                            <input type="text" hidden name="product_subcategory" value="">
